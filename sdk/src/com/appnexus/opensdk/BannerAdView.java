...
public class BannerAdView extends AdView {
    ...
    private boolean expandsToFitScreenWidth = true;
    ...
    public void expandToFitScreenWidth(int adWidth, int adHeight, AdWebView webview) {
        ...
        getLayoutParams().height=(int)(adHeight*ratio_delta);

        //Adjust height of webview
        ViewGroup.LayoutParams new_wv_lp = new ViewGroup.LayoutParams(webview.getLayoutParams());
        new_wv_lp.width = -1;
        new_wv_lp.height = getLayoutParams().height;

        //Set new layout params
        webview.setLayoutParams(new_wv_lp);
